...
def setup_routes(app: FastAPI) -> None:
    ...
    app.include_router(school_wallet_router,prefix="/school_wallet", tags=["school_wallet"])
    app.include_router(school_router,prefix="school_router", tags=["school_router"])
    app.include_router(settings_router,prefix="/settings", tags=["settings"])
    app.include_router(student_router,prefix="/student", tags=["student"])
    app.include_router(super_admin_wallet_router,prefix="/super_admin_wallet", tags=["super_admin_wallet"])
    app.include_router(transaction_router,prefix="/transaction", tags=["transaction"])
    app.include_router(user_roles_router,prefix="/user_roles", tags=["user_roles"])
    app.include_router(admin_wallet_router,prefix="/admin_wallet", tags=["admin_wallet"])
